...
const HeaderInventoryAdd = ({
    ...
    const BtnSort = ({ filterType, marked }) => {
        return (
            <TouchableOpacity onPress={() => sort(filterType)}>
                <Icon name="sort" size={14} type="solid" style={{ padding: 5 }} color={marked == true ? "#03d3ed" : "black"}></Icon>
            </TouchableOpacity>
        )
    }
    ...
    function sort(filterType) {
        ...
        if (orderBy == filterType || (orderFilter != null && orderFilter == filterType)) {
            var orderTypeTemp = "DESC";
            if (orderType == "DESC" || (orderByGlobal != null && orderByGlobal == "DESC")) {
                setOrderType("ASC");
                orderTypeTemp = "ASC";
            } else {
                setOrderType("DESC");
        ...
        <View style={styles.container}>

            {
                ...
                <CheckBox
                    ...
                    containerStyle={[styles.columnCheckBox, { width: 30, padding: 0, margin: 0, alignItems: "center" }]}
                />
            }
            ...
            <View style={[styles.containerColumnLeft, styles.containerColumn, { width: "15%" }]}>
                <Text style={[styles.column]}>Inventory ID</Text>
                {
                    sortBy &&
                    <BtnSort filterType="id" marked={orderBy == "id" || (orderFilter != null && orderFilter == "id")} />
                }
            ...
            <View style={[styles.containerColumn, { width: "20%" }]}>
                ...
                {
                    sortBy &&
                    <BtnSort filterType="clientref" marked={orderBy == "clientref" || (orderFilter != null && orderFilter == "clientref")} />
                }
            ...
            <View style={[styles.containerColumn, { width: "20%" }]}>
                ...
                {
                    sortBy &&
                    <BtnSort filterType="artist" marked={orderBy == "artist" || (orderFilter != null && orderFilter == "artist")} />
                }
            ...
            <View style={[styles.containerColumn, { width: "25%" }]}>
                ...
                {
                    sortBy &&
                    <BtnSort filterType="title" marked={orderBy == "title" || (orderFilter != null && orderFilter == "title")} />
                }

            </View>

            <View style={[styles.containerColumn, styles.containerColumnRight, { width: "20%", minWidth: 60 }]}>
