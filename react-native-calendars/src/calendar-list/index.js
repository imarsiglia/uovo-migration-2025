...
const MIN_HEIGHT_MIN_MONTH = 360;
...
class CalendarList extends Component {
  ...
  scrollToDay(d, offset, animated) {
    ...
    let scrollAmount = size * this.props.pastScrollRange + diffMonths * size + (offset ? offset + MIN_HEIGHT_MIN_MONTH : 0);
    ...
    return (
      <View>
        <FlatList
          ...
          contentContainerStyle={{paddingVertical: MIN_HEIGHT_MIN_MONTH}}
