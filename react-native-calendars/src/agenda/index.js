...
export default class AgendaView extends Component {
  ...
  render() {
    ...
    return (
      <View testID={this.props.testID} onLayout={this.onLayout} style={[this.props.style, {
        flex: 1, overflow: 'hidden',
        borderBottomColor: "#e3e3e3", borderLeftWidth: 0.5,
        borderLeftColor: "#e3e3e3",
        borderRightWidth: 0.5,
        borderRightColor: "#e3e3e3",
        borderBottomWidth: 0.6, borderBottomLeftRadius: 10,
        ...
        <Animated.View style={[headerStyle, {
          ...
          <Animated.View style={{
            flex: 1, transform: [{ translateY: contentTranslate }],
          }}>
            <CalendarList
              onLayout={() => {
